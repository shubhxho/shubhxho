  ...
  return (
    <HoverTipContext.Provider value={{ show, hide }}>
      ...
      {enabled && text ? (
        <div
          aria-hidden="true"
          className="pointer-events-none fixed z-50 max-w-[16rem] border border-border bg-background px-2.5 py-1.5 text-[11px] leading-4 text-muted-foreground shadow-sm"
          style={{
            left: pos.x + 14,
            top: pos.y + 16,
          }}
