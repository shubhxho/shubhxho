...
export function getHomeContent(): HomeContent {
  ...
  return {
    ...
    essaysLabel: attributes.essaysLabel ?? "Essays",
    essaysUrl: attributes.essaysUrl ?? "/essays",
    essaysLinkLabel: attributes.essaysLinkLabel ?? "all essays →",
    essaysPreviewCount: numberAttribute(attributes.essaysPreviewCount, 4),
    ...
    dailyLabel: attributes.dailyLabel ?? "Daily",
    dailyUrl: attributes.dailyUrl ?? "/daily",
    dailyLinkLabel: attributes.dailyLinkLabel ?? "all daily →",
    dailyPreviewCount: numberAttribute(attributes.dailyPreviewCount, 4),
