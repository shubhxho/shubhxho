export const trustPages = {
  about: {
    ...
    paragraphs: [
      ...
      "His work spans robotics, artificial intelligence, developer tools, systems software, Rust, Go, Linux, and high-frequency trading. The unifying interest is building useful, technically ambitious things and making difficult systems easier to understand or use. The homepage highlights selected projects and writing; the linked GitHub, Hugging Face, LinkedIn, X, and Instagram profiles provide additional primary-source context.",
