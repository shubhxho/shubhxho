...
For a quick professional introduction, use the official profiles linked from the [homepage](/) — GitHub, Kaggle, Hugging Face, LinkedIn, X, and Instagram. For open-source work, issues, and technical discussion related to a repository, use the relevant GitHub project so the context stays public and searchable. For notebooks and machine-learning work, see Kaggle and Hugging Face. Be cautious of accounts that use a similar name but are not linked from this domain.
