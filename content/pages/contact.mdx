...
For a quick professional introduction, use the [LinkedIn](https://www.linkedin.com/in/shubhxho) profile linked from the homepage. For open-source work, issues, and technical discussion related to a repository, use the relevant [GitHub](https://github.com/shubhxho) project so the context stays public and searchable. For notebooks and machine-learning work, see [Kaggle](https://www.kaggle.com/shubhxho) and [Hugging Face](https://huggingface.co/shubhxho). The official social and technical profiles linked from the homepage are the accounts associated with shubhxho. Be cautious of accounts that use a similar name but are not linked from this domain.
